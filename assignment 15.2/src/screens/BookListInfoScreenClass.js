...
class BookListInfoScreenClass extends React.Component{
  ...
  handleClick =(isbn)=>{
      ...
      let i = this.state.books.findIndex(book => book.isbn === isbn);
        ...
        <div className='BookListInfoScreen'>
            ...
            <div className='row'>
                <div className='col col-3'>
                    <BookListComponent books={this.state.books} onCellClick={this.handleClick}/>
                </div>
                <div className='col col-9'>
                    <BookDetailsComponent book={this.state.books[this.state.index]}/>
                </div>
            </div>
        </div>
    );
...
export default BookListInfoScreenClass;
