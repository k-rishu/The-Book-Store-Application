...
(
    ...
    function() {
        ...
        function populateList(books) {
            ...
            books.forEach(book => {
                ...
                <tr>
                    ...
                    <td>${book.rating}</td>
                    <td>
                        <a href="bookDetails.html" onclick = "getDetails('${encodeURIComponent(JSON.stringify(book))}');">Details</a>
                        <a href="editBook.html">Edit</a>
                        <a href="deleteBook.html">Delete</a>
                    </td>
                </tr>
        ...
        function handleSearch() {
            ...
            //     rating: document.getElement('Rating').value,
